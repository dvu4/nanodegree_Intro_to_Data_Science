...
def entries_histogram(turnstile_weather):
    ...
    turnstile_weather[turnstile_weather['rain'] == 0]['ENTRIESn_hourly'].hist(label='no rain') # your code here to plot a historgram for hourly entries when it is raining
    turnstile_weather[turnstile_weather['rain'] == 1]['ENTRIESn_hourly'].hist(label='rain') 
